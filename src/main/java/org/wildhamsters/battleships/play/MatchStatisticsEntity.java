...
public class MatchStatisticsEntity {
    ...
    public String toString() {
        return "MathStatisticsDto{" + "id=" + id + ", matchId='" + matchId + '\'' + ", accurateShots=" + accurateShots + ", missedShots=" + missedShots + ", rounds=" + rounds + ", startTime=" + startTime + ", finishTime=" + finishTime + '}';
    }
}
