...
// private void testLoop(BrowserPlayer firefoxPlayer, BrowserPlayer
// chromePlayer) {
...
// List<WebElement> elements = driver.findElements(By.xpath("//td[contains(@id,
// 'ocell') and contains(@class, 'water')]"));
